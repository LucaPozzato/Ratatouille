...
def dict_gen(product):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": "I need a dict that has a product, its product catgeory and the shelf_life and the day:" + str(today) + ". The dictionary should only have as keys: product, category in english, shelf_life is in days, date. The product is" + product + ".I only need the array, please don't generate other text. Don't say anything else."}
        ]
    )
